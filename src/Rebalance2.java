...
//
//public class Rebalance2 implements Runnable {
//
...
//
//    public Rebalance2(HashMap<Integer, List<String>> dstoreFiles, Controller controller, int R, Index index, CountDownLatch latch) {
//        this.latch = latch;
...
//        temp.put(15, new ArrayList<>(Arrays.asList("a.txt","b.txt","c.txt","d.txt")));
//        temp.put(16, new ArrayList<>(Arrays.asList("a.txt","b.txt")));
...
//
//        Rebalance2 rebalance = new Rebalance2(temp,null, 2, index,null);
//
